...
-- Fri 26 Dec 2025 08:18:12 AM CET
...
CREATE TABLE IF NOT EXISTS `playshogi`.`ps_lessons` (
  ...
  `old_campaign` TINYINT(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `playshogi`.`ps_campaign`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `playshogi`.`ps_campaign` ;

CREATE TABLE IF NOT EXISTS `playshogi`.`ps_campaign` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(255) NOT NULL,
  `description` MEDIUMTEXT NULL,
  `tags` VARCHAR(1000) NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_ps_campaign_1_idx` (`author_id` ASC),
  CONSTRAINT `fk_ps_campaign_1`
    FOREIGN KEY (`author_id`)
    REFERENCES `playshogi`.`ps_user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `playshogi`.`ps_campaign_lesson`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `playshogi`.`ps_campaign_lesson` ;

CREATE TABLE IF NOT EXISTS `playshogi`.`ps_campaign_lesson` (
  ...
  INDEX `fk_ps_campaign_lesson_2_idx` (`lesson_id` ASC),
  CONSTRAINT `fk_ps_campaign_lesson_1`
    FOREIGN KEY (`campaign_id`)
    REFERENCES `playshogi`.`ps_campaign` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ps_campaign_lesson_2`
    FOREIGN KEY (`lesson_id`)
    REFERENCES `playshogi`.`ps_lessons` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `playshogi`.`ps_campaign_lesson_prerequisite`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `playshogi`.`ps_campaign_lesson_prerequisite` ;

CREATE TABLE IF NOT EXISTS `playshogi`.`ps_campaign_lesson_prerequisite` (
  `campaign_id` INT UNSIGNED NOT NULL,
  `lesson_id` INT UNSIGNED NOT NULL,
  `prerequisite_lesson_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`campaign_id`, `lesson_id`, `prerequisite_lesson_id`),
  INDEX `fk_ps_campaign_lesson_prerequisite_2_idx` (`campaign_id` ASC, `prerequisite_lesson_id` ASC),
  CONSTRAINT `fk_ps_campaign_lesson_prerequisite_1`
    FOREIGN KEY (`campaign_id` , `lesson_id`)
    REFERENCES `playshogi`.`ps_campaign_lesson` (`campaign_id` , `lesson_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ps_campaign_lesson_prerequisite_2`
    FOREIGN KEY (`campaign_id` , `prerequisite_lesson_id`)
    REFERENCES `playshogi`.`ps_campaign_lesson` (`campaign_id` , `lesson_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `playshogi`.`ps_lesson_chapter`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `playshogi`.`ps_lesson_chapter` ;

CREATE TABLE IF NOT EXISTS `playshogi`.`ps_lesson_chapter` (
  ...
  INDEX `fk_ps_lesson_chapter_1_idx` (`lesson_id` ASC),
  INDEX `fk_ps_lesson_chapter_2_idx` (`kifu_id` ASC),
  UNIQUE INDEX `uq_ps_lesson_chapter_number` (`lesson_id` ASC, `chapter_number` ASC),
  CONSTRAINT `fk_ps_lesson_chapter_1`
    FOREIGN KEY (`lesson_id`)
    REFERENCES `playshogi`.`ps_lessons` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ps_lesson_chapter_2`
    FOREIGN KEY (`kifu_id`)
    REFERENCES `playshogi`.`ps_kifu` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
