...
public class ProxySettings implements HasProxySettings {
    ...
    /**
     * @param remoteServiceRelativePath the remoteServiceRelativePath to set
     */
    @Override
    ...
    /**
     * @param moduleBaseUrl the serverBaseUrl to set
     */
    @Override
    ...
    /**
     * @param waitForInvocation the waitForInvocation to set
     */
    @Override
