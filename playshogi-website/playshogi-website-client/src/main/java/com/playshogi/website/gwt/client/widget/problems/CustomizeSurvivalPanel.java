...
public class CustomizeSurvivalPanel extends Composite {
    ...
    private final TextBox numberOfMoves;
    ...
    public CustomizeSurvivalPanel() {
        ...
        grid.setWidget(4, 1, numberOfMoves);
    ...
    public ByoYomiPlace getCustomizedPlace() {
        ...
        int numberOfMovesValue = Integer.parseInt(numberOfMoves.getText());
        return new ByoYomiPlace(maxFailuresValue, raiseDifficultyEveryNValue, maxTimeSecValue, false,
                timePerMoveValue, numberOfMovesValue);
    }
