...
public enum Piece {
	SENTE_PAWN(true, PieceType.PAWN, false),
	SENTE_LANCE(true, PieceType.LANCE, false),
	SENTE_KNIGHT(true, PieceType.KNIGHT, false),
	SENTE_SILVER(true, PieceType.SILVER, false),
	SENTE_GOLD(true, PieceType.GOLD, false),
	SENTE_BISHOP(true, PieceType.BISHOP, false),
	SENTE_ROOK(true, PieceType.ROOK, false),
	...
	GOTE_PAWN(false, PieceType.PAWN, false),
	GOTE_LANCE(false, PieceType.LANCE, false),
	GOTE_KNIGHT(false, PieceType.KNIGHT, false),
	GOTE_SILVER(false, PieceType.SILVER, false),
	GOTE_GOLD(false, PieceType.GOLD, false),
	GOTE_BISHOP(false, PieceType.BISHOP, false),
	GOTE_ROOK(false, PieceType.ROOK, false),
